var Ground = (function () {
    function Ground(xSize, ySize) {
        if (xSize === void 0) { xSize = 10; }
        if (ySize === void 0) { ySize = 10; }
        var blocs = [];
    ...
    /**
      ...
      */
    Ground.prototype.drawBlocs = function () {
     ...
     */
    Ground.prototype.drawGrid = function (gridColor) {
        if (gridColor === void 0) { gridColor = black; }
        var iso = this.groundLayer.iso();
    ...
    /**
      ...
      * // @param Isomer iso : the layer to display on
      */
    Ground.prototype.drawAbsisse = function () {
        var iso = this.groundLayer.iso();
        // X absisse flag
     ...
     * // @param Isomer iso : the layer to display on
     */
    Ground.prototype.drawConvenients = function () {
