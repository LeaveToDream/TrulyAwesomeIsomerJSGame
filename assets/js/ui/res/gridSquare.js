...
// When in square mode
function drawSquareGrid (iso, xSize, ySize, zHeight, gridColor) {
...
/**
  ...
  * to display flags
  */
function drawSquareAbsisse (iso, xSize, ySize) {
  // X absisse flag
 ...
 */
function drawSquareConvenient (iso, xSize, ySize) {
  drawSquareGrid(iso, xSize, ySize, 0, new Color(10, 160, 0, 1));
  drawSquareAbsisse(iso, xSize, ySize);
}
